    ...
    <div class="col-md-12" id="divfilter">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            <div class="panel-heading">
                <h5 class="panel-title"><i class="icon-file-empty position-left"></i> REKAP RKPD PERUBAHAN OPD DAN UNIT KERJA TAHUN PERENCANAAN {{HelperKegiatan::getTahunPerencanaan()}}</h5>
